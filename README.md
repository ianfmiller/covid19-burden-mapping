...
######   This is more so a scenario we seek to investigate than an assumption about final epidemic size. A 40% cumulative infection rate would perhaps be considered pessimistic in the short term (i.e. next several months), but in optimistic the long term (i.e., beyond).
##### 2) equal infection rates across all age classes, 
######  The relationship between age and susceptibility in COVID-19 is still unclear. Several studies <a href="https://www.medrxiv.org/content/10.1101/2020.03.19.20039107v1">Zhang et al.</a>,<a href="https://www.nature.com/articles/s41591-020-0822-7">Wu et al.</a>) have found evidence that older individuals may be relatively more susceptible to infection than younger individuals. However, contact rates are higher amongst younger age classes. Currently, the combined effects of age dependent susceptibility and age dependent contact patterns on the distribution of infections across age classes are unkown. For now, we consider our assumption of equal infection rates across age classes to be safe, but we are on the lookout for any new findings that might allow us to refine this aspect of our methods.
##### 3) an asymptomatic rate of 20% in each age class,
######   Evidence about the percentage of infections that produce symptoms and the variation or lack thereof across age classes is still scarce. This estimate is consistent with the best available data (<a href="https://www.medrxiv.org/content/10.1101/2020.03.19.20039107v1">Zhang et al.</a>, but also see <a href="https://www.niid.go.jp/niid/en/2019-ncov-e/9407-covid-dp-fe-01.html">this report</a>).
